...
const AdminDelMedGroupConfirmationModal1 = ({medicineGroup, handleDelPost, onClose}) => {
        ...
        <div className="modal1">
            <div className="modal-box3">
                <div className="d-flex gap1 mar-bottom-1 align-items-center position-relative">
                    ...
                    <div className="text-l3 fw-bold text-center w-100">Delete Medicine Group</div>
                </div>

                <div className='d-flex flex-direction-y gap4 mar-bottom-1'>
                    {medicineGroup.group_name} will be permanently deleted, please input "I CONFIRM" if you want to delete this medicine.
                ...
                <div className="d-flex flex-direction-y gap3">
                    ...
                    onClick={() => {handleDelPost(medicineGroup.id); onClose()}}>
                        Delete
                    </button>
...
AdminDelMedGroupConfirmationModal1.propTypes = {
    onClose: propTypes.func.isRequired,
}

export default AdminDelMedGroupConfirmationModal1